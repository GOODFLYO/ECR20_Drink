...
contract Drink_Buy is ERC20_G12{
    ...
    address constant DrinkBuy = 0xD7ACd2a9FD159E69Bb102A1ca21C9a3e3A5F771B;
    ...
    function _buyDrink(string memory drinkname,uint num) public  returns (bool){
        ...
        // IERC20(DrinkBuy).approve(msg.sender,num*DrinkNP[drinkname]);
        // msg.sender.approve()
        // IERC20(DrinkBuy).transferFrom(msg.sender,OwnerDrink,num*DrinkNP[drinkname]);
        transfer(DrinkBuy,num*DrinkNP[drinkname]);
        IERC20(DrinkBuy).transfer(OwnerDrink,num*DrinkNP[drinkname]);
        DrinkNN[drinkname]--;
